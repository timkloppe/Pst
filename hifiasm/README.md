...
5. Overlap stats: graph is huge and dense consistent with very high coverage → tangled graph, more chances for misjoins or over‑collapsed regions. SOLUTION: Downsample HiFi reads
